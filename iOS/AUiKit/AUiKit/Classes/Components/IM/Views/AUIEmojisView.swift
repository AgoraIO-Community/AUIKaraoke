...
public class AUIEmojisView: UIView, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    override public init(frame: CGRect) {
        ...
        self.deleteEmoji.setImage(UIImage("backspace_clr",.voiceRoom), for: .normal)
        self.deleteEmoji.setImage(UIImage("backspace",.voiceRoom), for: .disabled)
...
public extension AUIEmojisView {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell?.icon.image = AUIChatEmojiManager.shared.emojiMap.isEmpty ? UIImage(AUIChatEmojiManager.shared.emojis[indexPath.row],.voiceRoom):AUIChatEmojiManager.shared.emojiMap[AUIChatEmojiManager.shared.emojis[indexPath.row]]
